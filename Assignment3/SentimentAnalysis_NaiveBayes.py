...
#A Naïve Bayes classifier with add-1 smoothing using binary bag-of-words features and n-grams.
...
result = cross_validate(MultinomialNB(alpha=1.0),X=X,y=Y,cv=10,scoring=['accuracy','f1'], return_train_score=False)
